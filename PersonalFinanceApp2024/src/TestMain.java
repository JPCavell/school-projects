...
public class TestMain {
    public static void main(String[] args) {
        IPersonalFinance pf = PersonalFinanceApp2024.getInstance();
    ...
    private static void testBudget(IPersonalFinance pf, ArrayList<Test> tests) {
        ...
        tests.add(new Test(
                ...
                () -> {
                    return pf.removeBudget("May 2022");
                },
                false
        ));
        tests.add(new Test(
                ...
                () -> {
                    try {
                        return pf.updateBudgetName("May 2022", "May '21") ||
                                pf.updateBudgetStartDate("May 2022", DateFormat.getDateInstance().parse("May 1, 2022")) ||
                                pf.updateBudgetEndDate("May 2022", DateFormat.getDateInstance().parse("May 31, 2022")) ||
                                pf.addOrUpdateBudgetItem("May 2022", "Rent", 1000.00);
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc =  pf.addBudget("May 2022",
                                DateFormat.getDateInstance().parse("May 1, 2022"),
                                DateFormat.getDateInstance().parse("May 31, 2022"),
                                null);
                        rc = rc && pf.addBudget("June 2022",
                                DateFormat.getDateInstance().parse("June 1, 2022"),
                                DateFormat.getDateInstance().parse("June 30, 2022"),
                                new HashMap<>());
                        rc = rc && pf.getCategories().size() == 3;
                        Iterator<IBudget> iterator = pf.getBudgets().iterator();
                        IBudget b = iterator.next();
                        rc = rc && b.getName().equals("May 2022") &&
                                b.getStartDate().compareTo(DateFormat.getDateInstance().parse("May 1, 2022")) == 0 &&
                                b.getEndDate().compareTo(DateFormat.getDateInstance().parse("May 31, 2022")) == 0 &&
                                b.getItems().isEmpty();
                        b = iterator.next();
                        rc = rc && b.getName().equals("June 2022") &&
                                b.getStartDate().compareTo(DateFormat.getDateInstance().parse("June 1, 2022")) == 0 &&
                                b.getEndDate().compareTo(DateFormat.getDateInstance().parse("June 30, 2022")) == 0 &&
                                b.getItems().isEmpty();
                        return rc;
                    } catch (ParseException e) {
                        e.printStackTrace();
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        return pf.addBudget("April 2022",
                                null,
                                DateFormat.getDateInstance().parse("April 30, 2022"),
                                null) ||
                                pf.addBudget("April 2022",
                                        DateFormat.getDateInstance().parse("April 30, 2022"),
                                        DateFormat.getDateInstance().parse("April 1, 2022"),
                                        null) ||
                                pf.addBudget("April 2022",
                                        DateFormat.getDateInstance().parse("April 1, 2022"),
                                        null,
        ...
        tests.add(new Test(
                ...
                () -> {
                    ...
                    try {
                        ...
                        rc[0] = true;
                        rc[1] = pf.addBudget("April 2022",
                                DateFormat.getDateInstance().parse("April 1, 2022"),
                                DateFormat.getDateInstance().parse("April 30, 2022"),
                                items);
                        rc[2] = pf.getBudgets().size() == 3;
                        for (IBudget b: pf.getBudgets()) {
                            if (b.getName().equals("May 2022") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("May 1, 2022")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("May 31, 2022")) == 0 &&
                                    b.getItems().isEmpty())
                                rc[3] = true;
                            else if (b.getName().equals("June 2022") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("June 1, 2022")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("June 30, 2022")) == 0 &&
                                    b.getItems().isEmpty())
                                rc[4] = true;
                            else if (b.getName().equals("April 2022") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("April 1, 2022")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("April 30, 2022")) == 0 &&
        ...
        tests.add(new Test(
                ...
                () -> {
                    ...
                    try {
                        ...
                        rc[0] = true;
                        rc[1] = pf.addBudget("March 2022",
                                DateFormat.getDateInstance().parse("March 1, 2022"),
                                DateFormat.getDateInstance().parse("March 31, 2022"),
                                items);
                        items.put("Paycheck", 2200.00);
                        items.put("Rent", 520.00);
                        items.put("Groceries", 220.00);
                        rc[2] = pf.addBudget("February 2022",
                                DateFormat.getDateInstance().parse("February 1, 2022"),
                                DateFormat.getDateInstance().parse("February 28, 2022"),
                                items);
                        ...
                        for (IBudget b: pf.getBudgets()) {
                            if (b.getName().equals("May 2022") &&
                                ...
                                rc[5] = true;
                                    ...
                                    b.getItems().get(map.get("Groceries")) == 200.00)
                                rc[6] = true;
                            else if (b.getName().equals("March 2022") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("March 1, 2022")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("March 31, 2022")) == 0 &&
                                    b.getItems().get(map.get("Paycheck")) == 2100.00 &&
                                    b.getItems().get(map.get("Rent")) == 510.00 &&
                                    b.getItems().get(map.get("Groceries")) == 210.00)
                                rc[7] = true;
                            else if (b.getName().equals("February 2022") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("February 1, 2022")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("February 28, 2022")) == 0 &&
        ...
        tests.add(new Test(
                ...
                () -> {
                    ...
                    for (ICategory c: categories)
                        map.put(c.getName(), c);
                    boolean rc = pf.removeBudget("February 2022");
        ...
        tests.add(new Test(
                ...
                () -> {
                    boolean rc = pf.updateBudgetName("May 2022", "May '21");
                    rc = rc && pf.getBudgets().size() == 4;
                    Map<String, ICategory> map = new HashMap<>();
                    Collection<ICategory> categories = pf.getCategories();
                    for (ICategory c: categories)
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = !pf.updateBudgetName("Jan 2022", "January 2022") &&
                                !pf.updateBudgetStartDate("Jan 2022", DateFormat.getDateInstance().parse("Jan 1, 2022")) &&
                                !pf.updateBudgetEndDate("Jan 2022", DateFormat.getDateInstance().parse("Jan 31, 2022")) &&
                                !pf.addOrUpdateBudgetItem("Jan 2022", "Rent", 1200.0);
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = !pf.updateBudgetName("June 2022", "April 2022") &&
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.updateBudgetStartDate("June 2022", DateFormat.getDateInstance().parse("June 2, 2022")) &&
                                pf.updateBudgetEndDate("May '21", DateFormat.getDateInstance().parse("May 29, 2022"));
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
                        ...
                        for (IBudget b: pf.getBudgets()) {
                            if (b.getName().equals("May '21") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("May 1, 2022")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("May 29, 2022")) == 0 &&
                                    b.getItems().isEmpty()) {
                            }
                            else if (b.getName().equals("June 2022") &&
                                    b.getStartDate().compareTo(DateFormat.getDateInstance().parse("June 2, 2022")) == 0 &&
                                    b.getEndDate().compareTo(DateFormat.getDateInstance().parse("June 30, 2022")) == 0 &&
                                    b.getItems().isEmpty()) {
                            }
                            else if (b.getName().equals("April 2022") &&
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = !pf.updateBudgetStartDate("June 2022", null) &&
                                !pf.updateBudgetStartDate("May '21", DateFormat.getDateInstance().parse("June 29, 2022"));
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = !pf.updateBudgetEndDate("June 2022", null) &&
                                !pf.updateBudgetEndDate("May '21", DateFormat.getDateInstance().parse("April 30, 2022"));
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
                ...
                () -> {
                    try {
                        boolean rc = pf.addOrUpdateBudgetItem("May '21", "Rent", 1200.0) &&
                                pf.addOrUpdateBudgetItem("April 2022", "Rent", 600);
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
                ...
                () -> {
                    try {
                        boolean rc = !pf.addOrUpdateBudgetItem("May '21", null, 1300.0) &&
                                !pf.addOrUpdateBudgetItem("April 2022", "Leccy", 700);
                        rc = rc && pf.getBudgets().size() == 4;
                        Map<String, ICategory> map = new HashMap<>();
                        Collection<ICategory> categories = pf.getCategories();
                        for (ICategory c: categories)
    ...
    private static void testTransaction(IPersonalFinance pf, ArrayList<Test> tests) {
        ...
        tests.add(new Test(
                ...
                ()-> {
                    try {
                        return pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2022"),
                                DateFormat.getDateInstance().parse("March 31, 2022")).size();
                    } catch (ParseException e) {
                        e.printStackTrace();
                        return -1;
                    }
        ...
        tests.add(new ExceptionTest(
                ...
                ()-> {
                    try {
                        return pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2022"),
                                DateFormat.getDateInstance().parse("March 1, 2022")).add(null);
                    } catch (ParseException e) {
                        e.printStackTrace();
                        return true;
                    }
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc =  pf.getTransactions(DateFormat.getDateInstance().parse("March 31, 2022"),
                                DateFormat.getDateInstance().parse("March 1, 2022")).isEmpty();
                        rc = rc && pf.getTransactions(null, DateFormat.getDateInstance().parse("March 1, 2022")).isEmpty();
                        rc = rc && pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2022"), null).isEmpty();
                        return rc;
                    } catch (ParseException e) {
                        e.printStackTrace();
                        return false;
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        ...
                        rc = rc && pf.addTransaction(DateFormat.getDateInstance().parse("August 1, 2022"),
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.addTransaction(DateFormat.getDateInstance().parse("March 1, 2022"),
                                "", 50.0, "Groceries", "Amex") == -1;
                        rc = rc && pf.addTransaction(DateFormat.getDateInstance().parse("March 1, 2022"),
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.addTransaction(DateFormat.getDateInstance().parse("March 2, 2022"),
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.addTransaction(DateFormat.getDateInstance().parse("March 15, 2022"),
                                "LSUS PPD", 2000.0, "Paycheck", "CFCU") == 2;
                        rc = rc && pf.addTransaction(DateFormat.getDateInstance().parse("April 1, 2022"),
                        ...
                        for (ITransaction i: transactions) {
                            if (i.getId() == 0) {
                                ...
                                rc = rc && i.getDate().compareTo(DateFormat.getDateInstance().parse("March 1, 2022")) == 0;
                                ...
                                rc = rc && i.getCategory().getName().equals("Groceries");
                                rc = rc && i.getDate().compareTo(DateFormat.getDateInstance().parse("March 2, 2022")) == 0;
                                ...
                                rc = rc && i.getDate().compareTo(DateFormat.getDateInstance().parse("March 15, 2022")) == 0;
                                ...
                                rc = rc && i.getDate().compareTo(DateFormat.getDateInstance().parse("April 1, 2022")) == 0;
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        ...
                        rc = rc && !pf.updateTransactionDate(6, DateFormat.getDateInstance().parse("March 31, 2022"));
        ...
        tests.add(new Test(
                ...
                () -> {
                    try {
                        boolean rc = pf.updateTransactionDate(2, DateFormat.getDateInstance().parse("March 21, 2022"));
                        Collection<ITransaction> transactions = pf.getTransactions(DateFormat.getDateInstance().parse("March 1, 2020"),
                                DateFormat.getDateInstance().parse("March 31, 2022"));
                        rc = rc && transactions.size() == 3;
                        for (ITransaction i: transactions) {
                            if (i.getId() == 1) {
                                ...
                                rc = rc && i.getAmount() == 2000.0;
                                rc = rc && i.getCategory().getName().equals("Paycheck");
                                rc = rc && i.getDate().compareTo(DateFormat.getDateInstance().parse("March 21, 2022")) == 0;
                                rc = rc && i.getDescription().equals("LSUS PPD");
                            }
                            else if (i.getId() == 3) {
                                rc = rc && i.getAccount().getName().equals("CFCU");
...
//                        else rc = false;
        ...
        tests.add(new Test(
                ...
                () -> {
                    ...
                    boolean rc = true;
                    try {
                        rc = rc && pf.addTransaction(DateFormat.getDateInstance().parse("March 2, 2022"),
