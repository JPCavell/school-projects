 ...
 * File Name: DBCustomer.java
 */

/*
 * This program is an options menu for the customer table in the database
...
class DBCustomer {
    ...
    public void CustomerTable(int option, Scanner keypress) throws SQLException, ParseException {
        option = 0;
        ...
        while (option <= 4) {
            ...
            System.out.println("-------------------------------------");
            System.out.println("1: Retreive Customer Data");
            ...
            if (option == 1) {
                ...
                DBInsertion.customerDataInsertion();
            } else if (option == 3) {
                DBDeletion.datadeletionCustomer();
            } else if (option == 4) {
                DBUpdate.customerDataModification(option);
            } else if (option == 5) {
                String[] args = null;
